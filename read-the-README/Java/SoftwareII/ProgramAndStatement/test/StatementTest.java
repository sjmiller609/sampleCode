 ...
 * 
 * @author Wayne Heym
 * @author Chaz Gordish, Steven Miller
 */
public abstract class StatementTest {
     ...
     * The name of a file containing a sequence of BL statements.
     */
    private static final String FILE_NAME_2 = "data/Call.bl";
    /**
     * The name of a file containing a sequence of BL statements.
     */
    private static final String FILE_NAME_3 = "data/CallZero.bl";
    /**
     * The name of a file containing a sequence of BL statements.
     */
    private static final String FILE_NAME_4 = "data/If.bl";
    /**
     * The name of a file containing a sequence of BL statements.
     */
    private static final String FILE_NAME_5 = "data/IfElse.bl";
    /**
     * The name of a file containing a sequence of BL statements.
     */
    private static final String FILE_NAME_6 = "data/IfElseZero.bl";
    /**
     * The name of a file containing a sequence of BL statements.
     */
    private static final String FILE_NAME_7 = "data/IfZero.bl";
    /**
     * The name of a file containing a sequence of BL statements.
     */
    private static final String FILE_NAME_8 = "data/WhileZero.bl";
    ...
    /**
     * Test addToBlock at an End position.
     */
    @Test
    public final void testAddToBlockEnd() {
        ...
        Statement nestedTest = sTest.removeFromBlock(1);
        Statement nestedRef = sRef.removeFromBlock(1);
        sRef.addToBlock(4, nestedRef);

        /*
         * The call
         */
        sTest.addToBlock(4, nestedTest);
    ...
    /**
     * Test addToBlock at an Front position.
     */
    @Test
    ...
    /**
     * Test removeFromBlock at the front leaving block with one child behind.
     */
    @Test
    public final void testRemoveFromBlockFrontLeavingOne() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_4);
        Statement sRef = this.createFromFileRef(FILE_NAME_4);
        Statement nestedRef = sRef.removeFromBlock(0);
    ...
    public final void testAssembleIfEmpty() {
         ...
         * Setup
         */
        Statement blockTest = this.createFromFileTest(FILE_NAME_7);
        Statement blockRef = this.createFromFileRef(FILE_NAME_7);
        Statement emptyBlock = blockRef.newInstance();
    ...
    public final void testAssembleIfElseEmpty() {
        ...
        Statement blockTest = this.createFromFileTest(FILE_NAME_6);
        Statement blockRef = this.createFromFileRef(FILE_NAME_6);
        Statement emptyBlock = blockRef.newInstance();
        Statement sourceTest = blockTest.removeFromBlock(ifElsePos);
        Statement sRef = blockRef.removeFromBlock(ifElsePos);
        Statement thenBlockTest = sourceTest.newInstance();
    ...
    /**
     * Test disassembleIfElseNonEmpty.
     */
    @Test
    ...
    public final void testDisassembleWhileEmpty() {
         ...
         */
        final int whilePos = 0;
        Statement blockTest = this.createFromFileTest(FILE_NAME_8);
        Statement blockRef = this.createFromFileRef(FILE_NAME_8);
        Statement sTest = blockTest.removeFromBlock(whilePos);
        Statement sRef = blockRef.removeFromBlock(whilePos);
        Statement nestedTest = sTest.newInstance();
        Statement nestedRef = sRef.newInstance();
