...
//
//        Map<String, Statement> result = this.context.newInstance();
//        while (this.context.size() > 0) {
//            Map.Pair<String, Statement> ctxt = this.context.removeAny();
//            String name = ctxt.key();
//            Statement body = ctxt.value();
//            result.add(name, body);
//        }
//        while (c.size() > 0) {
//            Map.Pair<String, Statement> ctxt = c.removeAny();
//            String name = ctxt.key();
//            Statement body = ctxt.value();
//            this.context.add(name, body);
//        }
//
//        return result;
        Map<String, Statement> result = this.context.newInstance();
        result.transferFrom(this.context);
...
//        Statement result = this.body.newInstance();
//
//        for (int i = 0; i < this.body.lengthOfBlock(); i++) {
//            Statement child = this.body.removeFromBlock(i);
//            result.addToBlock(i, child);
//        }
//
//        for (int i = 0; i < b.lengthOfBlock(); i++) {
//            Statement child = b.removeFromBlock(i);
//            this.body.addToBlock(i, child);
//        }
//
//        return result;
//    }
        Statement result = this.body.newInstance();
        result.transferFrom(this.body);
