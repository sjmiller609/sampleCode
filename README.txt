...
When you get into a directory, read the README, if one exists. They are not as long as this.
The code I have written in C is most recent, and is therefore the most mature.
I plan to update this file whenever I add some new code to this repo.
-------------------------------------------
-------------------------------------------
-------------------------------------------
4/14/2015:
...
I will "comment" the subject of each paragraph with //
